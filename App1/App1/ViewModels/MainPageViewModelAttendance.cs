...
{
    public class MainPageViewModelAttendance : BaseViewModel
    {
        ...
        public MainPageViewModelAttendance()
        {
            // Load Data
            SelectedData = new List<SelectableData<ExampleData>>()
            {
                ...
                new SelectableData<ExampleData>() { Data = new ExampleData() { Name = "Test6", Description = "Description5" } }
            };
        }
        ...
        public ICommand SelectCommandAttendance
        {
            get
            {
                return new Command(async () =>
                {
                    ...
                    await navPage.PushAsync(new ListViewPage2(SelectedData));
